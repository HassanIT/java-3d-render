...
public class ThreeDRender {
    ...
    public static void main(String[] args) {
        ...
        //slider to control the vertical rotation
        JSlider pitchSlider = new JSlider(SwingConstants.VERTICAL, -90, 90, 0);
        pane.add(pitchSlider, BorderLayout.EAST);

        //panel to display the render results
 ...
 // Uncomment this chunk of code to make it into a sphere /
                    for (int i = 0; i < 4; i++) {
                        triangleList = change(triangleList); 
                    }
    ...
    public static List<Triangle> inflate(List<Triangle> triangleList) {
    ...
    public static List<Triangle> change(List<Triangle> triangleList) {
        List<Triangle> result = new ArrayList<>();
        for (Triangle t : triangleList) {
            Vertex m1 = new Vertex((t.v1.x + t.v2.x) / 2, (t.v1.y + t.v2.y) / 2, (t.v1.z + t.v2.z) / 2);
            Vertex m2 = new Vertex((t.v2.x + t.v3.x) / 2, (t.v2.y + t.v3.y) / 2, (t.v2.z + t.v3.z) / 2);
